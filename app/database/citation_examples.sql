...
INSERT INTO citation_examples (site_slug, referencing_style, example_key, label, citation_order, example_heading, example_body, you_try, notes) VALUES
('cite-them-right','Harvard','book_one_author','Book with one author',
...
('cite-them-right','Harvard','book_two_authors','Book with two authors',
...
('cite-them-right','Harvard','book_three_plus','Book with three or more authors',
...
('cite-them-right','Harvard','edited_book','Edited book',
...
('cite-them-right','Harvard','chapter_in_edited','Chapter in an edited book',
...
('cite-them-right','Harvard','translated_book','Translated book',
...
('cite-them-right','Harvard','corporate_author','Corporate author book',
...
('cite-them-right','Harvard','no_author','Book with no identified author',
'Title (in italics)\nYear of publication in round brackets\nEdition (if not the first)\nPublisher',
...
('cite-them-right','Harvard','editor_as_author','Book with an editor instead of an author',
'Editor surname and initials followed by (ed.) or (eds.)\nYear of publication in round brackets\nTitle in italics\nEdition (if not the first)\nPublisher',
...
('cite-them-right','Harvard','reprinted_book','Reprinted book',
...
('cite-them-right','Harvard','multi_volume','Multi-volume book',
